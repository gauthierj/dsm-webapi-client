...
@Component
public class FileStationShareListServiceImpl extends AbstractDsmServiceImpl implements FileStationShareListService {

    public FileStationShareListServiceImpl() {
